function [result] = intraPreVerticalLeft(blockSize, preBlock1, preBlock2)
    ...
    result(1, 5) = round(preBlock1(8, 5) + preBlock1(8, 6)) / 2;
    result(1, 6) = round(preBlock1(8, 6) + preBlock1(8, 7)) / 2;
    result(1, 7) = round(preBlock1(8, 7) + preBlock1(8, 8)) / 2;
    result(1, 8) = round(preBlock1(8, 8) + preBlock2(8, 1)) / 2;
